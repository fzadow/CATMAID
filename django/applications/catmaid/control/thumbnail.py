...
@login_required
def make_thumbnail(request, project_id=None, stack_ids=None, x_min=None, x_max=None, y_min=None, y_max=None, z_min=None, z_max=None, zoom_level=None, tissue=None, metadata=None):
    ...
    job = ThumbnailingJob(request.user, project_id, stack_ids, x_min, x_max, y_min, y_max, z_min, z_max, zoom_level, tissue, metadata)
